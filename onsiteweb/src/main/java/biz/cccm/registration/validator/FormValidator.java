...
//        }
        ...
        if ((form.getMisc1() == null || form.getMisc1() == false ) && (form.getMisc2() == null || form.getMisc2() == false ) && (form.getMisc3() == null || form.getMisc3() == false )) {
            messages.addMessage(new MessageBuilder().error().source("misc1").defaultText("请選擇您要參加那一天的聚会Please select").build());
        }
