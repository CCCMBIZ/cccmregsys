<%-- 
    Document   : duplicate
    Created on : Dec 8, 2010, 11:51:10 PM
    Author     : CH1CHOO1
--%>
    ...
    <body>
        <div id="page">
            ...
            <div id="content" align="left">
                <p>You have more than 1 registration in the system. Please use the following registration id(s) to lookup your information. Contact registration@cccm.ws to remove your registration</p>
                <table class="summary">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <c:forEach var="rid" items="${duplicateList}">
                            <tr>
                                <td>${rid}</td>
                            </tr>
                        </c:forEach>
