...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see biz.cccm.service.impl.PasswordTokenManager#generateRecoveryToken(biz.cccm.model.User)
     */
    @Override
    ...
    /**
     * @see biz.cccm.service.impl.PasswordTokenManager#isRecoveryTokenValid(biz.cccm.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see biz.cccm.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
